...
const frontendDirectory = "unity";

const asset_entry = path.join("src", frontendDirectory, "build", "index.html");
...
module.exports = {
  ...
  entry: {
    ...
    index: path.join(__dirname, "src", frontendDirectory, "common", "index.js"),
  },
  ...
  devServer: {
    ...
    hot: true,
    watchFiles: [path.resolve(__dirname, "src", frontendDirectory, "build")],
    liveReload: true,
  },
};
